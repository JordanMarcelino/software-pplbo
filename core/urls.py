...
urlpatterns = [
    ...
    path("queue/", views.nomor_antrian, name='nomor_antrian'),
    path("queue/register/", views.daftar_antrian, name='daftar_antrian'),
    path("history/<str:id>", views.rekam_medis_detail, name='rekam_medis_detail'),
